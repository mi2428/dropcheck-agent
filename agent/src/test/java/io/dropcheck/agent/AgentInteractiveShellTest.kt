...
class AgentInteractiveShellTest {
    ...
    fun parsesUseCommands() {
        ...
        assertEquals(AgentShellCommand.ShowWifiScan(), AgentShellParser.parse("show wifi scan"))
        assertEquals(AgentShellCommand.ShowWifiScan("6ghz"), AgentShellParser.parse("sh wi sc 6"))
        assertEquals(AgentShellCommand.ShowWifiScanFresh("5ghz", 9000), AgentShellParser.parse("show wifi scan fresh 5ghz timeout 9000"))
        assertEquals(AgentShellCommand.ShowWifiScanDetail("Lab", "6ghz"), AgentShellParser.parse("show wifi scan detail 6ghz Lab"))
        assertEquals(AgentShellCommand.ShowWifiScanDetail("aa:bb:cc:dd:ee:ff", "5ghz"), AgentShellParser.parse("show wifi scan detail aa:bb:cc:dd:ee:ff 5ghz"))
    ...
    fun rejectsMalformedUseCommands() {
        ...
        assertEquals(AgentShellCommand.Invalid("usage: show (use|wifi status|wifi scan)"), AgentShellParser.parse("show"))
        assertEquals(AgentShellCommand.Invalid("usage: show (use|wifi status|wifi scan)"), AgentShellParser.parse("sh"))
        assertEquals(AgentShellCommand.Invalid("usage: show wifi <status|scan>"), AgentShellParser.parse("show wifi"))
        assertEquals(AgentShellCommand.Invalid("usage: show wifi status"), AgentShellParser.parse("show wifi status extra"))
        assertEquals(AgentShellCommand.Invalid("usage: show wifi scan [all|2.4ghz|5ghz|6ghz|60ghz]"), AgentShellParser.parse("show wifi scan 5ghz 6ghz"))
        assertEquals(AgentShellCommand.Invalid("usage: show wifi scan detail [all|2.4ghz|5ghz|6ghz|60ghz] <ssid|bssid>"), AgentShellParser.parse("show wifi scan detail"))
        assertEquals(AgentShellCommand.Invalid("usage: show wifi scan fresh [timeout MS] [all|2.4ghz|5ghz|6ghz|60ghz]"), AgentShellParser.parse("show wifi scan fresh timeout"))

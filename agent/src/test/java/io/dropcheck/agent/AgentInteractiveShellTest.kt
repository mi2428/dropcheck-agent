...
class AgentInteractiveShellTest {
    ...
    fun rejectsMalformedUseCommands() {
        ...
        assertEquals(AgentShellCommand.Invalid("usage: show (use|wifi status|wifi mlo)"), AgentShellParser.parse("show"))
        assertEquals(AgentShellCommand.Invalid("usage: show (use|wifi status|wifi mlo)"), AgentShellParser.parse("sh"))
        ...
        assertEquals(AgentShellCommand.Invalid("usage: show wifi mlo [fresh [timeout MS]]"), AgentShellParser.parse("show wifi mlo current"))
        assertEquals(AgentShellCommand.Invalid("usage: show wifi mlo [fresh [timeout MS]]"), AgentShellParser.parse("show wifi mlo fresh timeout"))

...
class AgentInteractiveShellTest {
    ...
    fun rejectsMalformedUseCommands() {
        ...
        assertEquals(AgentShellCommand.Invalid("usage: show (version|use|wifi status|wifi eht)"), AgentShellParser.parse("show"))
        assertEquals(AgentShellCommand.Invalid("usage: show (version|use|wifi status|wifi eht)"), AgentShellParser.parse("sh"))
        assertEquals(AgentShellCommand.Invalid("usage: show wifi (status|eht)"), AgentShellParser.parse("show wifi"))
        assertEquals(AgentShellCommand.Invalid("usage: show wifi status"), AgentShellParser.parse("show wifi status extra"))
        assertEquals(AgentShellCommand.Invalid("usage: show wifi (status|eht)"), AgentShellParser.parse("show wifi networks"))
        assertEquals(AgentShellCommand.Invalid("usage: show wifi eht [brief] [fresh [timeout MS]] [ssid SSID|bssid BSSID]"), AgentShellParser.parse("show wifi eht current"))
        assertEquals(AgentShellCommand.Invalid("usage: show wifi eht [brief] [fresh [timeout MS]] [ssid SSID|bssid BSSID]"), AgentShellParser.parse("show wifi eht fresh timeout"))
        ...
        assertEquals(AgentShellCommand.Invalid("usage: show wifi (status|eht)"), AgentShellParser.parse("show wifi mlo"))

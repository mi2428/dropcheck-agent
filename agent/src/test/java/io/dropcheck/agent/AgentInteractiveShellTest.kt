...
class AgentInteractiveShellTest {
    ...
    fun rejectsMalformedUseCommands() {
        ...
        assertEquals(AgentShellCommand.Invalid("usage: show (use|wifi status)"), AgentShellParser.parse("show wifi"))
        assertEquals(AgentShellCommand.Invalid("usage: show (use|wifi status)"), AgentShellParser.parse("show wifi status extra"))

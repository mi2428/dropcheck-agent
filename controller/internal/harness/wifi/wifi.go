// Package wifi provides Dropcheck Harness expectations for Wi-Fi status checks.
package wifi
...
func State() harness.OrderedMetric[string] {
...
func SSID() harness.OrderedMetric[string] {
...
func BSSID() harness.OrderedMetric[string] {
...
func Standard() harness.OrderedMetric[string] {
...
func FrequencyMHz() harness.OrderedMetric[int32] {
...
func Channel() harness.OrderedMetric[int32] {
...
func Band() harness.OrderedMetric[string] {
...
func LinkSpeedMbps() harness.OrderedMetric[int32] {
...
func TxLinkSpeedMbps() harness.OrderedMetric[int32] {
...
func RxLinkSpeedMbps() harness.OrderedMetric[int32] {
...
func RSSIDbm() harness.OrderedMetric[int32] {
...
func APMLDMAC() harness.OrderedMetric[string] {
...
func APMLOLinkID() harness.OrderedMetric[int32] {
...
func RawContains(value string) harness.Expectation {
...
func (e rawContains) Evaluate(result harness.Result) []harness.Finding {
	...
	return []harness.Finding{harness.Fail("wifi.raw", wifi.RawText, "contains "+e.value, "value not found")}
}
...
func (s MLOLinkSelector) Exists() harness.Expectation {
	return mloLinkExists{selector: s}
}

// Count matches the number of MLO links selected by the selector.
func (s MLOLinkSelector) Count() harness.OrderedMetric[int] {
...
func (e mloLinkExists) Evaluate(result harness.Result) []harness.Finding {
	...
	if len(matches) > 0 {
		return []harness.Finding{harness.Pass(e.selector.metric, describeMLOLink(matches[0]), "exists")}
	}
	return []harness.Finding{harness.Fail(e.selector.metric, describeMLOLinks(links), "exists", "no mlo link matched selector")}
}
...
func stringMetric(name string, observe func(Result) (string, bool, string)) harness.OrderedMetric[string] {
	return harness.Ordered[string](name, func(result harness.Result) (string, bool, string) {
		wifi, ok, reason := from(result)
		if !ok {
			return "", false, reason
		}
...
func intMetric(name string, observe func(Result) (int32, bool, string)) harness.OrderedMetric[int32] {
	return harness.Ordered[int32](name, func(result harness.Result) (int32, bool, string) {
		wifi, ok, reason := from(result)
		if !ok {
			return 0, false, reason
		}

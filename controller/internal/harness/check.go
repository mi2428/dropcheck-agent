...
// Check is one executable Dropcheck Harness check.
...
//
// IPStatus is the primary Dropcheck Harness check for layer-3 provisioning: DHCP,
...
//
// WiFiStatus is the primary Dropcheck Harness check for layer-2 Wi-Fi properties:

...
func Transmitted() festival.OrderedMetric[uint32] {
	return festival.Ordered[uint32]("ping.transmitted", func(result festival.Result) (uint32, bool, string) {
...
func Received() festival.OrderedMetric[uint32] {
	return festival.Ordered[uint32]("ping.received", func(result festival.Result) (uint32, bool, string) {
		ping, ok, reason := from(result)
...
func LossPercent() festival.OrderedMetric[float64] {
	return festival.Ordered[float64]("ping.loss_percent", func(result festival.Result) (float64, bool, string) {
		ping, ok, reason := from(result)
...
func MinLatency() festival.OrderedMetric[time.Duration] {
...
func AvgLatency() festival.OrderedMetric[time.Duration] {
...
func MaxLatency() festival.OrderedMetric[time.Duration] {
...
func ExitCode() festival.OrderedMetric[int32] {
	return festival.Ordered[int32]("ping.exit_code", func(result festival.Result) (int32, bool, string) {
		ping, ok, reason := from(result)
...
func durationMetric(name string, observe func(Result) time.Duration) festival.OrderedMetric[time.Duration] {
	return festival.Ordered[time.Duration](name, func(result festival.Result) (time.Duration, bool, string) {
		ping, ok, reason := from(result)

...
// network checks such as IP provisioning, Wi-Fi link status, ping, DNS, global
// IP, path MTU, and traceroute, then evaluates metric matchers and custom
// assertions against the raw agent result. Run integrates the plan with
